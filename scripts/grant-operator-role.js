...
async function main() {
  ...
  const roleHash = '0x97667070c54ef182b0f5858b034beac1b6f3089aa2d3188bb1e8929f4fa9b929'; // OPERATOR_ROLE

  console.log(`Granting OPERATOR_ROLE on FreightPassport (${contractAddress}) to user address: ${targetAddress}...`);
  ...
  try {
    ...
    if (hasRole) {
      console.log(`Address ${targetAddress} already has the OPERATOR_ROLE.`);
      return;
    }
    ...
    console.log(`Role OPERATOR_ROLE successfully granted to ${targetAddress}.`);
  } catch (err) {
